...
function recherche() {
	$recherche = "<form method=\"post\"><select>";

	$recherche .= "</select></form>";
				...
				<div class="wrapper style1">
					...
					<div class="container">
						<article id="main" class="special">
							<header>
								<h2 style="float: left;">Quelle lecture pour aujourd'hui ?</h2>
								<img style="height: 400px;" src="images/livreplume.png" alt="plume" />
							</header>
							<?php recherche(); ?>
